...
public class WasteDataControllerTest {
    ...
    public void ShouldNot_Retrieve_Id_1Mil_WasteData() {
        ...
        //Act
        ResponseEntity checkStatus = new ResponseEntity<ArticleData>(wasteDataController.getWasteDataById(OneMil).getStatusCode());
    ...
    public void Should_Retrieve_GivenWasteData_On_FilledWasteData() {
        ...
        ArticleData checkIfPresentBeforeTest = wasteDataController.getWasteDataById(wasteData.getId()).getBody();
        if (checkIfPresentBeforeTest != null) {
            wasteDataController.deleteWasteData(5000L);
        }

        //Act
        ArticleData result = wasteDataController.addWasteData(wasteData).getBody();
    ...
    public void Should_Delete_And_Notify_If_It_Existed() {
        //Arrange
        ArticleData checkIfNotPresentBeforeTest = wasteDataController.getWasteDataById(7000L).getBody();
    ...
    public void Should_Be_Unable_To_Update_OneMil_Id() throws ChangeSetPersister.NotFoundException {
        ...
        //Act
        ResponseEntity checkStatus = new ResponseEntity<ArticleData>(wasteDataController.updateWasteData(OneMil, wasteData).getStatusCode());
