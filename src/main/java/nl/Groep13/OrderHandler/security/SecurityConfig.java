...
//                .antMatchers("/api/v2/auth/register").hasRole("ADMIN")
//                .antMatchers("/api/v2/user/**").hasAnyRole("MEDEWERKER", "ADMIN")
//                .antMatchers("/api/v2/auth/user").hasAnyRole("MEDEWERKER", "ADMIN")
//                .antMatchers("/api/v2/auth/changepassword").hasAnyRole("MEDEWERKER", "ADMIN")
